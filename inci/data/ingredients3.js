...
{n:"PHENOXYETHANOL",c:"Etere aromatico di glicole",g:"ecc",f:"conservante",
 ...
 r:{t:"limitato",x:"Ammesso fino all'1%.",a:"Allegato V (voce 29)"}},
...
{n:"SODIUM BENZOATE",alt:["BENZOIC ACID","AMMONIUM BENZOATE","POTASSIUM BENZOATE"],c:"Sale dell'acido benzoico",g:"ecc",f:"conservante",
 ...
 r:{t:"limitato",x:"Acido benzoico e sali: 0,5% (come acido) nei prodotti senza risciacquo, 2,5% nei prodotti da risciacquo, 1,7% nei prodotti per il cavo orale.",a:"Allegato V (voce 1)"}},
...
{n:"POTASSIUM SORBATE",alt:["SORBIC ACID","SODIUM SORBATE"],c:"Sale dell'acido sorbico (acido grasso insaturo)",g:"ecc",f:"conservante",
 ...
 r:{t:"limitato",x:"Ammesso fino allo 0,6% (espresso come acido sorbico).",a:"Allegato V (voce 41)"}},
...
{n:"DEHYDROACETIC ACID",c:"Pirandione (acido organico)",g:"ecc",f:"conservante",
 ...
 r:{t:"limitato",x:"Acido deidroacetico e suoi sali: massimo 0,6% (come acido); vietato negli spray. Attenzione: il sodium dehydroacetate è stato vietato separatamente.",a:"Allegato V (voce 12)"}},
...
{n:"BENZYL ALCOHOL",c:"Alcol aromatico",g:"ecc",f:"conservante, solvente, allergene da profumo",
 ...
 t:[0.3,1],ph:{e:"neutro",v:6.5},
 r:{t:"limitato",x:"Massimo 1% come conservante; come componente di profumo va dichiarato in etichetta sopra 0,001% nei prodotti senza risciacquo e 0,01% in quelli da risciacquo.",a:"Allegato V (voce 34) / Allegato III (voce 45)"}},
...
{n:"METHYLPARABEN",alt:["ETHYLPARABEN","SODIUM METHYLPARABEN","SODIUM ETHYLPARABEN","POTASSIUM METHYLPARABEN"],c:"Estere dell'acido para-idrossibenzoico (parabene a catena corta)",g:"ecc",f:"conservante",
 ...
 r:{t:"limitato",x:"Massimo 0,4% per singolo parabene e 0,8% come somma di tutti i parabeni presenti.",a:"Allegato V (voce 12)"}},
...
{n:"PROPYLPARABEN",alt:["BUTYLPARABEN","SODIUM PROPYLPARABEN","SODIUM BUTYLPARABEN"],c:"Estere dell'acido para-idrossibenzoico (parabene a catena lunga)",g:"ecc",f:"conservante",
 ...
 r:{t:"limitato",x:"Massimo 0,14% (somma); vietato nei prodotti senza risciacquo per la zona del pannolino nei bambini sotto i 3 anni.",a:"Allegato V (voce 12a)"}},
...
{n:"ISOPROPYLPARABEN",alt:["ISOBUTYLPARABEN","PHENYLPARABEN","BENZYLPARABEN","PENTYLPARABEN"],c:"Parabene ramificato o aromatico",g:"ecc",f:"conservante",
 ...
 r:{t:"vietato",x:"Vietati nei cosmetici dal 2015 (regolamento (UE) 358/2014) per mancanza di dati adeguati sulla sicurezza.",a:"Allegato II (voci 1374-1378)"}},
...
{n:"METHYLISOTHIAZOLINONE",alt:["MI","MIT"],c:"Isotiazolinone (eterociclo con zolfo e azoto)",g:"ecc",f:"conservante",
 ...
 r:{t:"limitato",x:"Vietato nei prodotti senza risciacquo dal 2017; ammesso solo nei prodotti da risciacquo fino allo 0,0015% (15 ppm).",a:"Allegato V (voce 57)"}},
...
{n:"METHYLCHLOROISOTHIAZOLINONE",alt:["METHYLCHLOROISOTHIAZOLINONE/METHYLISOTHIAZOLINONE","CMIT/MIT","KATHON CG"],c:"Isotiazolinone clorurato",g:"ecc",f:"conservante",
 ...
 t:[0.0001,0.0015],ph:{e:"neutro",v:6.5},
 r:{t:"limitato",x:"Solo nei prodotti da risciacquo, massimo 0,0015% della miscela 3:1 con metilisotiazolinone; non può essere usato insieme al solo metilisotiazolinone.",a:"Allegato V (voce 39)"}},
...
{n:"FORMALDEHYDE",alt:["FORMALIN","METHYLENE GLYCOL","PARAFORMALDEHYDE"],c:"Aldeide semplice",g:"ecc",f:"conservante",
 ...
 r:{t:"vietato",x:"Vietata nei cosmetici (regolamento (UE) 2019/831), compreso l'uso per lisciare i capelli.",a:"Allegato II (voce 1577)"}},
...
{n:"CHLORPHENESIN",alt:["IODOPROPYNYL BUTYLCARBAMATE","CAPRYLHYDROXAMIC ACID","p-ANISIC ACID","LEVULINIC ACID","SODIUM LEVULINATE","GLUCONOLACTONE"],c:"Conservante o sostanza ad azione antimicrobica",g:"ecc",f:"conservante",
 ...
 r:{t:"limitato",x:"Clorfenesina massimo 0,3%; iodopropinil butilcarbammato con limiti dallo 0,005% allo 0,02% secondo il tipo di prodotto e vietato nei prodotti per bambini sotto i 3 anni.",a:"Allegato V (voci 50 e 56)"}},
...
{n:"TRICLOSAN",alt:["TRICLOCARBAN"],c:"Fenolo clorurato",g:"funz",f:"antibatterico",
 ...
 r:{t:"limitato",x:"Triclosan ammesso solo in dentifrici, saponi, deodoranti non spray, ciprie e correttori (0,3%) e in collutori (0,2%). Triclocarban massimo 0,2% (1,5% nei prodotti da risciacquo).",a:"Allegato V (voci 25 e 23)"}},
...
{n:"PIROCTONE OLAMINE",alt:["CLIMBAZOLE","SELENIUM DISULFIDE","KETOCONAZOLE"],c:"Antifungino organico (idrossipiridone / azolo)",g:"funz",f:"antiforfora",
 ...
 r:{t:"limitato",x:"Piroctone olamina: 1% nei prodotti da risciacquo e 0,5% negli altri. Climbazolo: limiti specifici per tipo di prodotto (0,2-2%).",a:"Allegato V (voci 61 e 32)"}},
...
{n:"SODIUM HYDROXIDE",alt:["POTASSIUM HYDROXIDE","CALCIUM HYDROXIDE","LITHIUM HYDROXIDE"],c:"Base inorganica forte (alcali)",g:"ecc",f:"regolatore di pH",
 ...
 r:{t:"limitato",x:"Limiti stretti secondo l'uso: fino al 5% negli scioglicuticole, 2% nei lisciviatori per capelli di uso professionale fino al 4,5%, con avvertenze obbligatorie; vietato negli altri usi sopra queste soglie.",a:"Allegato III (voce 15)"}},
...
{n:"TRIETHANOLAMINE",alt:["TEA","AMINOMETHYL PROPANOL","TROMETHAMINE","TRIS","ARGININE","SODIUM CITRATE","SODIUM PHOSPHATE","TRISODIUM CITRATE","POTASSIUM CITRATE","SODIUM BICARBONATE","AMMONIUM HYDROXIDE"],c:"Base organica / sale tampone",g:"ecc",f:"regolatore di pH",
 ...
 r:{t:"limitato",x:"La trietanolammina è ammessa fino al 2,5% nei prodotti senza risciacquo, con tenore massimo di ammine secondarie e senza sostanze nitrosanti, per evitare la formazione di nitrosammine.",a:"Allegato III (voce 62)"}},
...
{n:"TALC",c:"Silicato di magnesio idrato",g:"ecc",f:"assorbente, scorrevolezza",
 ...
 r:{t:"limitato",x:"Deve essere privo di amianto. Nei prodotti in polvere per bambini sotto i 3 anni è obbligatoria l'avvertenza di tenere la polvere lontana dal naso e dalla bocca.",a:"Allegato III (voce 96)"}},
...
{n:"SODIUM FLUORIDE",alt:["SODIUM MONOFLUOROPHOSPHATE","STANNOUS FLUORIDE","AMINE FLUORIDE","OLAFLUR"],c:"Sale inorganico del fluoro",g:"funz",f:"anticarie",
 ...
 r:{t:"limitato",x:"Massimo 0,15% di fluoro (1500 ppm) nei prodotti per l'igiene orale; oltre lo 0,1% è obbligatoria un'avvertenza per i bambini.",a:"Allegato III (voci 26-43)"}},
...
{n:"ALUMINUM CHLOROHYDRATE",alt:["ALUMINUM ZIRCONIUM TETRACHLOROHYDREX GLY","ALUMINUM SESQUICHLOROHYDRATE","ALUMINUM CHLORIDE","POTASSIUM ALUM","ALUM"],c:"Sale di alluminio",g:"funz",f:"antitraspirante",
 ...
 r:{t:"limitato",x:"Ammessi come antitraspiranti; il parere SCCS del 2020 ne ha confermato la sicurezza entro limiti di concentrazione definiti per tipo di prodotto (fino al 6,25% negli spray e 10,60% nei roll-on, espressi come alluminio).",a:"Allegato III (voce 308)"}},
...
{n:"HYDROGEN PEROXIDE",alt:["PEROXIDE"],c:"Perossido inorganico (ossidante)",g:"funz",f:"ossidante, schiarente",
 ...
 r:{t:"limitato",x:"Massimo 12% (40 volumi) nei prodotti per capelli, 4% per la pelle, 2% per l'indurimento delle unghie, 0,1% per i prodotti del cavo orale. Avvertenze e guanti obbligatori.",a:"Allegato III (voce 12)"}},
...
{n:"AMMONIUM HYDROXIDE",alt:["AMMONIA","ETHANOLAMINE","MONOETHANOLAMINE","MEA"],c:"Base alcalina volatile o organica",g:"funz",f:"alcalinizzante per tinture",
 ...
 r:{t:"limitato",x:"Ammoniaca ammessa fino al 6%; sopra il 2% è obbligatoria l'indicazione \"contiene ammoniaca\".",a:"Allegato III (voce 4)"}},
...
{n:"P-PHENYLENEDIAMINE",alt:["PPD","TOLUENE-2,5-DIAMINE","P-AMINOPHENOL","M-AMINOPHENOL","RESORCINOL","4-AMINO-M-CRESOL","2-METHYLRESORCINOL","HYDROXYETHYL-P-PHENYLENEDIAMINE SULFATE"],c:"Ammina aromatica (precursore di colore ossidativo)",g:"funz",f:"colorante per capelli",
 ...
 r:{t:"limitato",x:"Ammessi solo nelle tinture ossidative per capelli con limiti stretti (p-fenilendiammina massimo 2% dopo miscelazione) e avvertenze obbligatorie: \"può provocare una reazione allergica\", non usare su under 16, non usare per tingere ciglia e sopracciglia.",a:"Allegato III (voci 8-16)"}},
...
{n:"THIOGLYCOLIC ACID",alt:["AMMONIUM THIOGLYCOLATE","ETHANOLAMINE THIOGLYCOLATE","CYSTEAMINE HCL","SODIUM THIOGLYCOLATE"],c:"Acido tiolico (riducente)",g:"funz",f:"riducente per permanenti e creme depilatorie",
 ...
 r:{t:"limitato",x:"Massimo 8% nei prodotti per capelli a uso domestico (11% professionale, pH 7-9,5) e 5% nelle creme depilatorie, con avvertenze e guanti obbligatori.",a:"Allegato III (voce 2)"}},
